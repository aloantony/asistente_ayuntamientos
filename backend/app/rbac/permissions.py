...
INITIAL_PERMISSION_DEFINITIONS: dict[str, str] = {
    ...
    "heritage.view": "Ver el patrimonio y el archivo municipal",
    "heritage.edit": "Editar el patrimonio y el archivo municipal",
    "heritage.manage": "Gestionar el patrimonio y el archivo municipal",
    ...
    "plenos.view": "Ver los plenos municipales",
    "plenos.edit": "Editar los plenos municipales",
    "plenos.manage": "Gestionar los plenos municipales",
    ...
    "town_hall.view": "Ver la pantalla del Ayuntamiento",
    "town_hall.edit": "Editar la pantalla del Ayuntamiento",
    "town_hall.manage": "Gestionar la pantalla del Ayuntamiento",
