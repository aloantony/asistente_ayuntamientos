...
INITIAL_PERMISSION_DEFINITIONS: dict[str, str] = {
    ...
    "documents.draft": "Preparar borradores documentales revisables",
    "documents.review": "Revisar borradores documentales",
    "documents.export": "Solicitar exportación de documentos aprobados",
    ...
    "assistant.knowledge.propose": "Proponer fuentes de conocimiento del asistente",
    "assistant.knowledge.view": "Ver fuentes de conocimiento aprobadas del asistente",
    "assistant.knowledge.review": "Revisar propuestas de fuentes de conocimiento del asistente",
    "assistant.web.search": "Buscar en la web desde el asistente",
    "assistant.drafts.create": "Crear borradores de trabajo del asistente",
    "assistant.drafts.view": "Ver borradores de trabajo del asistente",
    "assistant.drafts.review": "Revisar borradores de trabajo del asistente",
    "assistant.documents.summarize": "Resumir documentos visibles desde el asistente",
    "assistant.external.integrations": "Usar integraciones externas controladas del asistente",
    "assistant.debug.view_actions": "Ver detalle técnico y auditoría de acciones del asistente",
