...
REQUIREMENTS_INTAKE_INSTRUCTIONS = """Tu tarea es capturar requisitos.
...
- Antes de crear un requisito, comprueba con list_requirements si ya existe algo parecido; si existe, propone actualizarlo o añadir una nota en lugar de duplicar.
- Crea los requisitos siempre como borrador y resume al usuario lo que has guardado. Solo pásalos a 'submitted' cuando el usuario lo confirme.
...
- Para requisitos registrados, usa list_requirements cuando el usuario pida un listado, resumen, estado general o "qué tenemos"; usa get_requirement solo cuando necesites el detalle de un requisito concreto.
...
AGENT_REGISTRY: dict[str, AgentSpec] = {
    "requirements_intake": AgentSpec(
        ...
        name="Requisitos",
        description=(
            "Captura y mantiene requisitos, memoria propuesta y funcionalidades "
            "transversales supervisadas."
        ),
        objective=(
            "Conversar para descubrir necesidades municipales, crear o actualizar "
            "requisitos como borradores, proponer memoria revisable y sugerir "
