...
from app.assistant.prompts import ORDINANCE_PROMPT_BLOCK
...
def test_prompt_separates_inventory_from_semantic_retrieval():
    assert (
        ...
        in ORDINANCE_PROMPT_BLOCK
    )
    assert "get_ordinance_corpus_manifest" in ORDINANCE_PROMPT_BLOCK
    assert "complete_against_official_sources=false" in ORDINANCE_PROMPT_BLOCK
