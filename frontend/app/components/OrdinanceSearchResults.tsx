...
export function OrdinanceSearchResults({
  ...
  if (page.results.length === 0) {
    return (
      <div className={styles.emptyState}>
        <h2>No hay coincidencias indexadas</h2>
        <p>
          Prueba una consulta más amplia, elimina algún filtro o cambia el
          ámbito de resultados. Las normas sin curación técnica aprobada no
          aparecen en esta biblioteca.
        </p>
      </div>
    );
  }
  ...
  return (
    <>
      {page.retrieval.quality_warning ? (
      ...
      <div className={styles.resultList}>
        {page.results.map((result, index) => {
          ...
          const referenceDate =
            result.effective_date ?? result.publication_date;
          ...
          return (
            ...
            >
              ...
              >
                ...
                <small>Ver ficha jurídica y texto indexado</small>
              </button>
              ...
              {result.legal_review_status !== "human_approved" ? (
                <p className={styles.legalWarning} role="status">
                  <ShieldAlert aria-hidden="true" />
                  Pendiente de revisión jurídica humana. Úsala como referencia y
                  contrasta la fuente enlazada.
                </p>
              ) : null}
              ...
              <div className={styles.matchExcerpt}>
                ...
                {result.text_truncated ? (
                  <small>
                    Extracto abreviado; el texto indexado está en la ficha.
                  </small>
                ) : null}
              </div>
