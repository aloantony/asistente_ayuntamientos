# iConcejo — operational reference (English)

> **This is not the repository landing page.** [`README.md`](README.md) is the
> starting point (Spanish): what iConcejo is, quick start, modules and
> architecture. This file is the exhaustive operational reference — every
> environment variable, every assistant runtime and every security guarantee —
> kept in English because that is the language of the code.
>
> Licence: source-available, all rights reserved. See [LICENSE](LICENSE).
...
- Make iConcejo the persistent primary experience and expose modules as contextual work surfaces.
