...
- El bloque de temperatura del Ayuntamiento (`app/town_hall/weather.py`) es el único punto de egreso externo del proyecto que no es de IA: consulta Open-Meteo desde el servidor con el nombre de la localidad y sus coordenadas, y nada más. Ver ADR-022.
